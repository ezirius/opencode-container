...
RUNTIME_ENV_FILE="${OPENCODE_WRAPPER_RUNTIME_ENV_FILE:-/tmp/opencode-wrapper-runtime.env}"
CONFIG_ENV_FILE="${OPENCODE_WRAPPER_CONFIG_ENV_FILE:-/workspace/opencode-workspace/.config/opencode/config.env}"
SECRETS_ENV_FILE="${OPENCODE_WRAPPER_SECRETS_ENV_FILE:-/workspace/opencode-workspace/.config/opencode/secrets.env}"
CR="$(printf '\r')"
