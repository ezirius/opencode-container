...
grep -q 'Image naming: `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>`' "$ROOT/README.md"
grep -q 'Project container naming: `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>-<workspace>-<project>`' "$ROOT/README.md"
grep -q 'Shared runtime naming: `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>-<workspace>`' "$ROOT/README.md"
...
grep -q 'always opens the published server URL in the default browser on macOS and Linux after the shared runtime is ready\.' "$ROOT/docs/usage/shared/usage.md"
...
grep -q 'Built images are named `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>`\.' "$ROOT/docs/usage/shared/usage.md"
grep -q 'Shared runtime containers are named `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>-<workspace>`\.' "$ROOT/docs/usage/shared/usage.md"
grep -q 'Project containers are named `opencode-<version>-<YYYYMMDD-HHMMSS>-<full-image-id>-<workspace>-<project>`\.' "$ROOT/docs/usage/shared/usage.md"
...
grep -q '`-next-<pid>` container' "$ROOT/docs/usage/shared/usage.md"
