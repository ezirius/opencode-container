...
grep -q '^OPENCODE_SHARED_CONTAINER_SCOPE="infrastructure"$' "$ROOT/config/agent/shared/opencode-settings-shared.conf"
...
grep -q '<workspace>-infrastructure' "$ROOT/docs/usage/shared/usage.md"
grep -q '<workspace>-<project>' "$ROOT/docs/usage/shared/usage.md"
