...
grep -q 'Shared runtime naming: `opencode-<version>-<YYYYMMDD-HHMMSS>-<12-character-image-id>-<workspace>`' "$ROOT/README.md"
...
grep -q 'Shared runtime containers are named `opencode-<version>-<YYYYMMDD-HHMMSS>-<12-character-image-id>-<workspace>`\.' "$ROOT/docs/usage/shared/usage.md"
