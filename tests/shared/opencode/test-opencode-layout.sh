...
test -f "$ROOT/configs/shared/opencode/opencode-settings.conf"
...
grep -q '^OPENCODE_VERSION="1.14.25"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_SERVER_PORT="4096"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_BASE_PATH="\$HOME/Documents/Ezirius/.applications-data/.containers-artificial-intelligence"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_DEVELOPMENT_ROOT="\$HOME/Documents/Ezirius/Development/OpenCode"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_WORKSPACES="ezirius:10000 nala:20000"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_CONTAINER_HOME="/root"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_CONTAINER_WORKSPACE="/workspace/documents"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_CONTAINER_DEVELOPMENT="/workspace/development"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_CONTAINER_PROJECTS="/workspace/projects"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_CONTAINER_PROJECT="/workspace/project"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_SHARED_CONTAINER_SCOPE="infrastructure"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_HOST_WORKSPACE_DIRNAME="opencode-documents"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_DEFAULT_COMMAND="opencode"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_SHELL_COMMAND="nu"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_RELEASE_API_URL="https://api.github.com/repos/anomalyco/opencode/releases/latest"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_RELEASE_CONNECT_TIMEOUT_SECONDS="2"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_RELEASE_MAX_TIMEOUT_SECONDS="5"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_SERVER_HOSTNAME="0.0.0.0"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_ATTACH_HOST="127.0.0.1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_RUNNING_WAIT_ATTEMPTS="10"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_RUNNING_WAIT_SECONDS="1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_STABLE_WAIT_ATTEMPTS="2"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_STABLE_WAIT_SECONDS="1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_PUBLISHED_URL_WAIT_ATTEMPTS="5"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_PUBLISHED_URL_CONNECT_TIMEOUT_SECONDS="1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_PUBLISHED_URL_MAX_TIMEOUT_SECONDS="1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
grep -q '^OPENCODE_PUBLISHED_URL_WAIT_SECONDS="1"$' "$ROOT/configs/shared/opencode/opencode-settings.conf"
...
grep -q '`configs/shared/opencode/opencode-settings.conf`' "$ROOT/AGENTS.md"
