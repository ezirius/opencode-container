...
grep -q '^OPENCODE_CONTAINER_PROJECT_DIR="/workspace/opencode-project"$' "$ROOT/config/shared/opencode.conf"
...
grep -q '^project_names_from_development_root() {$' "$ROOT/lib/shell/common.sh"
grep -q '^resolve_selected_project_name() {$' "$ROOT/lib/shell/common.sh"
grep -q '^container_project_dir() {$' "$ROOT/lib/shell/common.sh"
grep -q '^project_mount_spec() {$' "$ROOT/lib/shell/common.sh"
grep -q '^container_project_mount_matches_workspace_config() {$' "$ROOT/lib/shell/common.sh"
